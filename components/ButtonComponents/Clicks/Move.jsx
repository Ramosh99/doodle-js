import rough from 'roughjs/bundled/rough.esm';
  ...
  export  function isMouseOnLineSegment(mouseX, mouseY, x1, y1, x2, y2, tolerance = 5) {
 ...
 export function selectTheShapeMouseDown(startX, startY,setStarx,setStary,setIsDragging,setCurrentSelectedIndex,setActiveElem,elements) {
 ...
 export const updateShapeCordinates = (index, newX1, newY1, newx2, newy2,elements,setActiveElem,setElements,setUndoStack,setRedoStack) => {
