...
export default function Selectors({ mode, activeElem }) {
  ...
  if (type === 'rectangle') {
    ...
    return (
      <div>
        <div className='selectors' id='start' style={{ top: `${y1 - 4}px`, left: `${x1 - 4}px` }}></div>
        <div className='selectors' id='end' style={{ top: `${y2 - 4}px`, left: `${x2 - 4}px` }}></div>
      </div>
    );
  }
